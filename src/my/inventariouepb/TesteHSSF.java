 ...
 * users.
 */
public final class TesteHSSF {

	/**
	 * creates an {@link HSSFWorkbook} the specified OS filename.
	 */
	private static HSSFWorkbook leArquivo(String filename) throws IOException {
	 ...
	 * rows/cells.
	 */
	private static void criaPlanilhaExemplo(String outputFilename) throws IOException {
		int rownum;
...
//			c.setCellStyle(cs3);
     ...
     * see {@link TesteHSSF#criaPlanilhaExemplo(String)}.<br/>
     *
	...
	public static void main(String[] args) {
		...
		String fileName = JOptionPane.showInputDialog("Endereço do arquivo:");
		try {
			 

				HSSFWorkbook wb = TesteHSSF.leArquivo(fileName);
				...
				wb.close();
                                ...
                                TesteHSSF.criaPlanilhaExemplo(fileName);
